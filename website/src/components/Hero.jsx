      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        ...
        <Reveal delay={340}>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a href="https://jup.ag/swap?sell=So11111111111111111111111111111111111111112&buy=LVCKzJ9zgzF7nbw8zE7Nxtua4JdAUWfneDNSXVgTEST" className="rounded-2xl px-6 py-3 border border-white-400 hover:border-white-300 flex items-center
            ...
            <a href="https://dexscreener.com/solana/LVCKzJ9zgzF7nbw8zE7Nxtua4JdAUWfneDNSXVgTEST" className="rounded-2xl px-6 py-3 border border-white-400 hover:border-white-300 flex items-center bg-transparent hover:bg-green-500/20 font-semibold transition">
              <img src="https://dexscreener.com/favicon.ico" alt="DexScreener Logo" className="inline-block mr-2 h-5 align-middle" />
              CHART
            </a>
            <a href="https://x.com/testrewardtoken" className="rounded-2xl px-6 py-3 border border-white-400 hover:border-white-300 flex items-center bg-white/0 hover:bg-cyan-400/10 transition font-medium">
