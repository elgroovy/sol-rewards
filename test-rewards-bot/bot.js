...
// Example of a JSON structure for the /api/rewardnotis endpoint sent using CURL
/*
curl -X POST http://localhost:3000/api/rewardnotis \
...
app.post('/api/rewardnotis', (req, res) => {
